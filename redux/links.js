...
export const REGISTER_LINK = `${LINK_DISTRIBUTION}/register.ajx?vid=${VID}&mt=1`;
...
export const ADD_TO_SUPP_CART = (vid, itemId, lang) =>
  `${LINK_DISTRIBUTION}/uservices/1.0.2/product-page/${VID}/iid/${itemId}/lang/${lang}/`;

export const GET_WISHLIST = (pageNumber, vid = null) =>
  `${LINK_DISTRIBUTION}/wishlistservice.ajx?vid=${vid || VID}`;

export const WISHLIST_LINK = (vid = null) =>
  `${LINK_DISTRIBUTION}/wishlistservice.ajx?vid=${vid || VID}/`;
