...
export default function SingleNews() {
  ...
  const queryArticle = qs.stringify({
    _where: [
      { "blogcategory.slug_ne": "press-release" },
      { Site: "https://www.avetticommerce.com/" }
    ]
  });
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_AVETTI_CMS}/articles?${queryArticle}`)
      .then(res => {
        setRecent(res.data);
      })
      .catch(error => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_AVETTI_CMS}/articles?slug=${router.query.slug}`)
      .then(res => {
      ...
      <Wrapper>
        ...
        <div className="row">
          <div className="leftcolumn">
            ...
            <div className="card-left">
              {article.image && <img src={article.image.url}></img>}
