                  ...
                  <div>
                    <div>
                      ...
                      >
                        ...
                        >
                          {storeTitle} <img src={imageUrl} alt="store logo" />
                        </h2>
                        <p>
        ...
        <Container>
          <>
            <div style={{ display: "flex" }}>
              <div class="sub-nav-menu-titleee sub-nav-menu-title-business">
                <h2>
                  {" "}
                  {storeTitle}{" "}
                  <span>
                  ...
                  <div className="flex flex-wrap w-full">
                    {query.map(q => (
                      <div
                        ...
                        onClick={() =>
                          setQuery([
                            ...query.filter(qy => qy.value !== q.value)
                          ])
                        }
                      >
...
export async function getStaticProps({ params, locale }) {
  ...
  console.log("URLCapitalize", URLWithoutSpace, `'${URLCapitalize}'`);
