...
import FacetsMvp from "../../components/Facets/FacetsMvp";
...
const Category = ({
  ...
  console.log("lastUrlState", lastUrlState);
      ...
      />
        ...
        <div className="facets-and-category-items-wrapper flex-row block">
          ...
          <div className="productsContainer">
            {/*  */}
            <Fade direction="right" delay={1e3} cascade damping={0.1} triggerOnce  style={{width: "100%"}}>
