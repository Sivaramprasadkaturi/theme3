...
import RelatedItemsProductpage from "../../components/RelatedItemsProductpage";
...
const Product = ({
  ...
  const firstSupplierVid = useMemo(() => {
    if (supplierInfo?.[0]?.distributorOrder?.length > 0) {
      const vid = supplierInfo[0].distributorOrder[0].name;
      console.log("vid", vid);
      return vid;
    }
    ...
    return (
      <>
        {currentIndexOfProductInTheCategory > 0 && (
          <Link
            href={`/${allProductsOfTheCategory?.productUrls[
    ...
    <>
      ...
      <Container>
        ...
        {isMobileState ? (
          ...
          <div className="flex flex-col md:flex-row">
            <div className="productLeft">
              <div style={{ position: "sticky", top: "-1px", zIndex: "9" }}>
                <DesktopCarousel
                  // className="hidden md:block"
                  code={productDetailsData.code}
                  hiddenProps={productDetailsData.hiddenProperties}
            ...
            <div className="flex-auto lg:w-32 md:w-16">
              <div>
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: "14px", fontWeight: "400" }}>{firstSupplierVid}</span><br />
                    {productInitialData.title}
                  </h2>
                ...
                >
                  ...
                  <div className="sizeChat">Size Chart</div>
                </div>
              </div>
              <ReviewBar
                reviews={reviews}
...
{}
              ...
              <p className="shortdesc">{itemDetailState.shortdesc ? itemDetailState.shortdesc : "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo." }</p>
